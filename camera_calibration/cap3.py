...
while True:
    ...
    retR, cornersR = cv2.findChessboardCorners(grayR,(6,6),None)  # Define the number of chess corners we are looking for (9,6)
    retL, cornersL = cv2.findChessboardCorners(grayL,(6,6),None)  # Left side
    ...
    if (True == retR) & (True == retL) :
        ...
        cv2.drawChessboardCorners(grayR,(6,6),corners2R,retR)
        cv2.drawChessboardCorners(grayL,(6,6),corners2L,retL)
